...
output_dir = os.path.join(derivatives_dir,'fmriprep') #level 1
fmriprep_work_dir = os.path.join(wf_dir, 'wf_fmriprep')
...
# participants_file=participants_file[:1]
subs_rerun = ['']
...
output_space = ' '.join( ['MNI152NLin6Asym', 'T1w'] )
